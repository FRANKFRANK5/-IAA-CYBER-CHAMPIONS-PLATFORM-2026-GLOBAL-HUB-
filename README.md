...
- `/CTFd`: Core engine source code.
- `/docker-compose.yml`: System orchestration.
- `/custom_branding`: Logo na assets za Frank Cyber-Unit.

---

## 📊 2026 Roadmap
- [x] Full System Cleanup & Takeover.
- [x] Custom Neon Matrix Theme Integration.
- [ ] Launch Challenge Set 1: Web Exploitation.
- [ ] National Talent Scouting (IAA Chapter).
